...
export const topic8: TopicDef = {
  ...
  steps: [
    ...
    { id: 'play', scene: { views: ['globe', 'flat'], point: HOME, pointEditable: true, precision: 'auto', sun: equinoxNoon, layers: { graticuleStep: 'auto', specialLines: true, daylight: true }, overlays: [{ kind: 'noon-meridian' }], labControls: ['sun-time', 'sun-date', 'now', 'clocks'] } },
  ],
};
