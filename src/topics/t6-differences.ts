...
export const topic6: TopicDef = {
  ...
  steps: [
    ...
    { id: 'over-180', scene: { views: ['globe', 'flat'], point: null, rotate: [-171, -30], layers: { specialLines: true, places: false }, overlays: [{ kind: 'marker', p: tokyo, tone: 'a', label: '140°E' }, { kind: 'marker', p: honolulu, tone: 'b', label: '158°W' }, { kind: 'lon-diff', a: tokyo, b: honolulu }] } },
